<?php
	...
	echo json_encode([
		...
		'grain' => rand(0, 100000),
		'release_changes' => [
			['title' => '- Это полностью новое приложение пересобранное с нуля, с использованием нового для Prodimex метода связи и нативных инструментов разработки.']
		],
		'apkSize' => $apkSize,
		'apklist' => $apklist,
		'forceUpdate' => true
